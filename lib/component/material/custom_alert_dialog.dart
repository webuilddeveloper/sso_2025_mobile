...
///  * [showDialog], which actually displays the dialog and returns its result.
///  * <https://material.io/design/components/dialogs.html#dialogs-alerts>
class CustomAlertDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (actions != null) {
      children.add(ButtonTheme(child: ButtonBar(children: actions!)));
    }
...
///  * <https://material.io/design/components/dialogs.html#dialogs-simple-dialogs>
...
Future<T?> customShowDialog<T>({
  ...
  return Navigator.of(context, rootNavigator: true).push<T>(
    _DialogRoute<T>(
      child: builder != null ? Builder(builder: builder) : Container(),
