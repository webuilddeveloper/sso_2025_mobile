...
import 'package:sso/component/material/custom_alert_dialog.dart';
...
class PolicyV2Page extends StatefulWidget {
  const PolicyV2Page({super.key, required this.category, this.navTo});
...
class _PolicyV2Page extends State<PolicyV2Page> {
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                ...
                image: AssetImage('assets/background/background_policy.png'),
              ),
            ),
                          ...
                          child: Scrollbar(
                            child: SingleChildScrollView(
                              ...
                              child: Container(
                                ...
                                child: Html(data: model[index]['description']),
                              ),
                            ),
                          ),
                        ),
  ...
  backIndex(dynamic model) {
    ...
    setState(() {
      if (lastPage) {
        lastPage = false;
        acceptPolicyList.removeWhere(
          (item) => item['index'] == currentCardIndex,
        );
      } else {
        currentCardIndex--;
        acceptPolicyList.removeWhere(
