...
class EventCalendarFormPage extends StatefulWidget {
  const EventCalendarFormPage({Key? key, this.model}) : super(key: key);
...
class _EventCalendarFormPageState extends State<EventCalendarFormPage> {
  ...
  _callRead() {
    _future = postDio('${server}m/eventCalendar/read', {
      'code': widget.model['code'],
    });
    _futureGallery = postDio('${server}m/eventCalendar/gallery/read', {
      'code': widget.model['code'],
    });
  }
