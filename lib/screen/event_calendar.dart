// ignore_for_file: library_private_types_in_public_api, prefer_interpolation_to_compose_strings, curly_braces_in_flow_control_structures, unnecessary_to_list_in_spreads
...
class _EventCalendarPageState extends State<EventCalendarPage>
  ...
  late ValueNotifier<List<dynamic>> _highlightEvents;
  ...
  getMarkerEvent() async {
    ...
    if (result != null) {
      ...
      itemEvent = { for (var item in markData) DateTime.parse(item['date']) : item['items'] };
...
final _kEventSource = { for (var item in List.generate(1, (index) => index)) DateTime.utc(kFirstDay.year, kFirstDay.month, item * 5) : [
          {
            "code": "",
            "dateStart": "20201222",
            "dateEnd": "20201225",
